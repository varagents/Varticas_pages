            ...
            <div className="pt-32 pb-20 px-4 max-w-4xl mx-auto relative">
                ...
                <article className="prose prose-invert prose-lg max-w-none prose-headings:font-display prose-a:text-brand-red hover:prose-a:text-brand-orange prose-strong:text-white prose-li:text-gray-300">
                    ...
                    <section id="data-usage">
                        ...
                        <h3>3.2 Use of Google User Data</h3>
                        <p>Varticas accesses Google user data (such as Gmail messages, Google Calendar events, or other Google Workspace data) only to provide the functionality explicitly requested by the user within the application.</p>
                        <p>For example, this may include:</p>
                        <ul>
                        ...
                        <p>Google user data is processed solely to perform the user-requested actions and is not used for any unrelated purposes.</p>
                        <p>Varticas does NOT use Google user data for:</p>
                        <ul>
                        ...
                        <p>Any Google user data accessed through Google APIs is used only during the execution of the requested feature and is not stored for AI model training.</p>
                    ...
                    <section id="google-compliance">
                        ...
                        <p>Varticas' use and transfer of information received from Google APIs adheres to the Google API Services User Data Policy, including the Limited Use requirements.</p>
                        <p>Google user data is accessed and used only to provide or improve user-facing features that are explicitly requested by the user. Varticas does not use Google user data for advertising, marketing, data brokerage, or training generalized artificial intelligence models.</p>
                    </section>
